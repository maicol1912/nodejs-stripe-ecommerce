...
import { orderStatus, paymentStatus } from '../shared/schema/order';
...
export class OrdersService {
  ...
  async webhook(rawBody: Buffer, sig: string) {
    try {
      let event;
      try {
        console.log("Llego un nuevo evento de stripe")
  ...
  private sendOrderEmail(email: string, orderId: string, orderLink: string) {
